...
public class GateWayExceptionHandlerAdvice {
    ...
    public Result handle(ResponseStatusException ex) {
        ...
        return Result.fail(ResultEnum.GATEWAY_ERROR);
    }

    @ExceptionHandler(value = {ConnectTimeoutException.class})
    public Result handle(ConnectTimeoutException ex) {
        log.error("connect timeout exception:{}", ex.getMessage());
        return Result.fail(ResultEnum.GATEWAY_CONNECT_TIME_OUT);
    }
    ...
    public Result handle(NotFoundException ex) {
        ...
        return Result.fail(ResultEnum.GATEWAY_NOT_FOUND_SERVICE);
    }
